#!/usr/bin/env python
#
# configoat documentation build configuration file, created by
...
version = configoat.__version__
# The full version, including alpha/beta/rc tags.
release = configoat.__version__
...
htmlhelp_basename = 'configoatdoc'
